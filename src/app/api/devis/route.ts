...
const RECIPIENT_EMAIL = process.env.DEVIS_RECIPIENT_EMAIL;
...
export async function POST(request: Request) {
  try {
    ...
    const mailToClient = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          ...
          <p>En attendant, vous pouvez explorer nos <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/realisations" style="color: #0077be; text-decoration: none;">réalisations</a> ou en apprendre plus sur <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/a-propos" style="color: #0077be; text-decoration: none;">notre expertise</a>.</p>
    ...
    return NextResponse.json({ message: 'Échec de l\'envoi de la demande de devis.' }, { status: 500 });
  }
}